...
<AccordionGroup>
  ...
  <Accordion title="Can I export my project and continue elsewhere?">
    Yes. Your project folder contains everything needed to:
    - Open in Xcode
    - Build independently
    - Hand off to a developer
    - Continue without Nativeline

    You own the code. There's no vendor lock-in.
  </Accordion>
