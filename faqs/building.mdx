...
<AccordionGroup>
  ...
  <Accordion title="What is a 'plan' and why does the AI make one?">
    For complex requests, the AI creates a plan—a todo list of steps it will follow. This helps you:
    - See what the AI intends to do
    - Catch misunderstandings before work begins
    - Track progress on multi-step features

    You can use `/planclear` to clear the current plan and start fresh.
  </Accordion>
  ...
  <Accordion title="What happens when the AI can't fix a bug?">
    ...
    1. Press "Run App"
    2. A popup appears asking if you want to fix
    3. Click "Apply Fix" to try again
