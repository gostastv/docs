...
<AccordionGroup>
  <Accordion title="How much does Nativeline cost?">
    ...
    | BYOK | $15/month + API costs | Unlimited (your own API key) |
  ...
  <Accordion title="What happens when I run out of bits?">
    ...
    - Switch to BYOK plan with your own API key
  </Accordion>
  ...
  <Accordion title="Can I buy extra bits?">
    ...
    - Upgrade to a higher plan (more bits included)
    - Switch to BYOK plan with your own API key (unlimited usage)
  </Accordion>

  <Accordion title="What is BYOK (Bring Your Own Key)?">
    BYOK is a $15/month plan that lets you use your own Anthropic API key:
    - Pay $15/month to Nativeline for platform access
    - Pay Anthropic directly for your actual AI usage
    - Unlimited AI interactions (no bit limits)
    - Full code editor access included
  ...
  <Accordion title="Can I cancel my subscription?">
    ...
    - You can export code (Pro plan or higher)
  ...
  <Accordion title="Can I get a refund?">
    For refund requests, please contact support@nativeline.ai with:
    - Your account email
