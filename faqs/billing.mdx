...
<AccordionGroup>
  ...
  <Accordion title="What are bits?">
    ...
    - Reading your code (2-5 bits)
    - Creating features (20-80 bits)
    - Fixing bugs (15-40 bits)
    - Complex operations (100+ bits)
  ...
  <Accordion title="How many bits do I need?">
    ...
    | Usage | Bits/Month |
    |-------|------------|
    | Light (exploring) | 300-500 |
    | Moderate (one app) | 800-1,200 |
    | Heavy (multiple apps) | 2,000+ |

    Start with the Basic plan. You can always upgrade if you need more.
  </Accordion>
