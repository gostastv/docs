...
<Steps>
  ...
  <Step title="Click Apply Fix">
    Select **Apply Fix** — the AI will automatically analyze the error and fix it.
  </Step>
</Steps>

### Providing Context (Optional)

Apply Fix works automatically, but you can optionally message the AI with additional context if the automatic fix doesn't work:
...
Most fixes work without extra context.
