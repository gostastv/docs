...
| Add a simple component (button, field) | 50-150 bits |
...
<AccordionGroup>
  ...
  <Accordion title="I'm building my first real app" icon="seedling">
    **Builder ($25) or Pro ($50)**
    ...
    For a first app, expect to use 1,000-2,000 bits/month. Consider:
    - **Builder** if you just want the app
  ...
  <Accordion title="I'm building multiple apps or complex features" icon="layer-group">
    **Scale ($100+/month)**
    ...
    Calculate your needs: Simple app ≈ 1,000-2,000 bits. Complex app ≈ 3,000-5,000 bits.
  </Accordion>
...
<Steps>
  <Step title="Initial creation (~500 bits)">
    "Create a task list app with add and complete features"
  </Step>
  <Step title="Add due dates (~150 bits)">
    "Add due dates to tasks with a date picker"
  </Step>
  <Step title="Fix a bug (~200 bits)">
    "Tasks aren't saving when I close the app"
  </Step>
  <Step title="Polish design (~50 bits)">
    "Make the cards have rounded corners and shadows"
  </Step>
  <Step title="Add categories (~300 bits)">
    "Add categories like Work, Personal, Shopping"
  </Step>
</Steps>

**Total: ~1,200 bits** (fits in Builder plan)

A more complex app with cloud sync, user accounts, and multiple screens might use 3,000-5,000 bits.
